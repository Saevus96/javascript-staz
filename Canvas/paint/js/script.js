const paint = {
    ...
    clearCanvas: function (e) {
        this.ctx.clearRect(0, 0, this.canvasCnt.offsetWidth, this.canvasCnt.offsetHeight);
        this.canvasBg.src = 'assets/texture.jpg';
    },
    ...
    mouseMove: function (e) {
        if (this.canDraw) {
            ...
            if (this.mode === 'triangle') {
                ...
                this.ctx2.lineTo(mousePos.x, mousePos.y);
                this.ctx2.lineTo(this.startX * (1 / 2), mousePos.y);
            ...
            if (this.mode == 'circle') {
                this.ctx2.clearRect(0, 0, this.canvasElem2.width, this.canvasElem2.height);
                this.ctx2.beginPath();
                this.ctx2.arc(this.startX, this.startY, Math.abs((this.startX - mousePos.x) + (this.startY - mousePos.y)), this.radianAngle(0), this.radianAngle(360), false);
                this.ctx2.stroke();
            }
        }
    },
    ...
    mouseDisable: function (e) {
        ...
        if (this.mode === 'line' || this.mode === 'rectangle' || this.mode === 'triangle' || this.mode === 'circle') {
    ...
    init: function () {
        ...
        this.canvasBg.addEventListener('load', function () {
            this.avaibleMode = ['draw', 'line', 'rectangle', 'triangle', 'circle'];
